...
>): Record<AllStandardObjectFieldName<'person'>, FlatFieldMetadata> => ({
  ...
  properties: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      ...
      label: i18nLabel(msg`Properties`),
      description: i18nLabel(msg`Properties associated with this person`),
      icon: 'IconHome',
      isNullable: true,
  ...
  quoteRequests: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Quote requests from this person`),
