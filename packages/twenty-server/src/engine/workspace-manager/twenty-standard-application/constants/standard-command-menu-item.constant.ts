...
export const STANDARD_COMMAND_MENU_ITEMS = {
  ...
  goToCalendar: {
    universalIdentifier: 'db94a724-3c95-4136-b7e9-e7b18ff49253',
  ...
  goToCleaningDashboard: {
    universalIdentifier: 'e8b5c835-4d06-4247-c8f0-f8d29f50364d',
    label: 'Go to Cleaning Dashboard',
    icon: 'IconBroom',
    isPinned: true,
    position: 45,
    shortLabel: 'Cleaning Dashboard',
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: null,
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
    engineComponentKey: EngineComponentKey.NAVIGATION,
    hotKeys: ['G', 'D'],
    payload: { path: '/cleaning-dashboard' },
  },
  goToSettings: {
